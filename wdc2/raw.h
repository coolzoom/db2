...
{
	std::uint32_t wdc2_unk_header1;       // always 0 in Battle (8.0.1.26231) and unnamed in client binary
	std::uint32_t wdc2_unk_header2;       // always 0 in Battle (8.0.1.26231) and unnamed in client binary
	...
	std::uint32_t offset_map_offset;      // Offset to array of struct {std::uint32_t offset; std::uint16_t size;}[max_id - min_id + 1];
